...
const menuData = [
  ...
  { id: 3, name: "BBQ BEEF BACON BEAST", image: "/images/bbq_beef_bacon_beast.png", category: "Signature Burgers", price: 13.95, description: "Two 3oz smashed beef patties, cheddar cheese, smoky BBQ sauce, onion jam and crispy beef bacon in a toasted potato bun.", quote: "Sweet, smoky and unapologetically indulgent." },
  ...
  { id: 5, name: "OKLAHOMA JALAPEÑO SMASH", image: "/images/oklahoma_jalapeno_smash.png", category: "Signature Burgers", price: 13.95, description: "Double 3oz Oklahoma-style smashed beef with sweet grilled onions, double American cheese, mustard aioli and jalapeño pickles.", quote: "Sweet heat meets smash burger perfection." },
  { id: 6, name: "THE OKLAHOMA CLASSIC", image: "/images/oklahoma_classic.png", category: "Signature Burgers", price: 12.95, description: "Double 3oz Authentic Oklahoma onion smash burger with grilled onions, double American cheese, mustard aioli in our potato bun.", quote: "The burger that started the smash burger movement." },
  { id: 7, name: "DEVSON’S MAC & ALGERIAN ATTACK", image: "/images/mac_algerian_attack.png", category: "Signature Burgers", price: 14.95, description: "Two 3oz smashed beef patties stacked with creamy macaroni cheese, crispy onions and our famous Algerian burger sauce.", quote: "Comfort food meets smash burger heaven.", badge: "Most Indulgent", badgeIcon: "Flame" },
  ...
  { id: 9, name: "VEG DELIGHT BOX", image: "/images/veg_delight_box.png", category: "Chicken & Veg Boxes", price: 13.95, description: "Veggie Burger, Skin-On Fries and Drink." },
  ...
  { id: 11, name: "BBQ BEAST FRIES", image: "/images/bbq_beast_fries.png", category: "Loaded Fries", price: 8.95, description: "Skin-on fries loaded with cheddar cheese, smoky BBQ sauce and crispy onions." },
